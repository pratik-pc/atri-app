  ...
  "Home": {
    ...
    "Image41": {
      "custom": {
        ...
        "src": "/app-assets/rainbow-text%20(2).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox4": {
      "custom": {
        "text": "that delight and inspire me."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox5": {
      "custom": {
        "text": "Hi! I am Pratik, a software enthusiast and programmer based in India. I have developed projects and currently an App developer at Navalogy club"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image38": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/WhatsApp%20Image%202022-12-29%20at%202.20.21%20PM.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox10": {
      "custom": {
        "text": "I believe I should be hired because I have the right skillset, potential, and intent to learn."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox13": {
      "custom": {
        "text": "Every developer has multiple techstacks under their belt. Thankfully I am multilingual"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox14": {
      "custom": {
        "text": "I am passionate about software and  make an effort to learn new things when I am not sure about the subject matter"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox114": {
      "custom": {
        "text": "Learn and gain experience"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox115": {
      "custom": {
        "text": "Contribute relevant skills to the team"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox16": {
      "custom": {
        "text": "I have worked on a number of cool personal projects."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image21": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-right-arrow-48.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox51": {
      "custom": {
        "text": "Over the past year, I've worked on multiple projects using different technologies. I love problem solving and learning new technologies"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox118": {
      "custom": {
        "text": "BTech(Electrical Engineering)"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image36": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-mail-50.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox66": {
      "custom": {
        "text": "pratikchanda2000@gmail.com"
      },
      "callbacks": {
        "onClick": [
          {
        ...
        "testimonials": [
          {
            ...
            "profile_pic": "/app-assets/img.png"
          },
          {
            "name": "John Frankin",
            ...
            "profile_pic": "/app-assets/project2.jpg"
          }
        ]
      },
      "callbacks": {
